...
macosODConfig = {
    'Attribute Type Map' : [ {'Native Map':['cn'],              'Standard Name':'dsAttrTypeStandard=RecordName'},
                             ...
                             {'Native Map':['modifyTimestamp'], 'Standard Name':'dsAttrTypeStandard=ModificationTimestamp'}],
    ...
    'Record Type Map'    : [
            {'Standard Name'      :   'dsRecTypeStandard=Users',
             'Attribute Type Map' : [{'Native Map':['uid','cn'],                     'Standard Name':'dsAttrTypeStandard=RecordName'},
                                     ...
                                     {'Native Map':['homeDirectory'],                'Standard Name':'dsAttrTypeStandard=NFSHomeDirectory'},
                                     {'Native Map':['apple-user-homeurl'],           'Standard Name':'dsAttrTypeStandard=HomeDirectory'},
                                     {'Native Map':['apple-user-homequota'],         'Standard Name':'dsAttrTypeStandard=HomeDirectoryQuota'},
                                     {'Native Map':['apple-user-homesoftquota'],     'Standard Name':'dsAttrTypeStandard=HomeDirectorySoftQuota'},
                                     {'Native Map':['apple-user-mailattribute'],     'Standard Name':'dsAttrTypeStandard=MailAttribute'},
                                     {'Native Map':['apple-user-printattribute'],    'Standard Name':'dsAttrTypeStandard=PrintServiceUserData'},
                                     {'Native Map':['apple-mcxflags'],               'Standard Name':'dsAttrTypeStandard=MCXFlags'},
                                     {'Native Map':['apple-mcxsettings'],            'Standard Name':'dsAttrTypeStandard=MCXSettings'},
                                     {'Native Map':['apple-user-adminlimits'],       'Standard Name':'dsAttrTypeStandard=AdminLimits'},
                                     ...
                                     {'Native Map':['authAuthority'],                'Standard Name':'dsAttrTypeStandard=AuthenticationAuthority'},
                                     {'Native Map':['apple-user-authenticationhint'],'Standard Name':'dsAttrTypeStandard=AuthenticationHint'},
                                     {'Native Map':['apple-user-passwordpolicy'],    'Standard Name':'dsAttrTypeStandard=PasswordPolicyOptions'},
                                     {'Native Map':['acctFlags'],                    'Standard Name':'dsAttrTypeStandard=SMBAccountFlags'},
                                     {'Native Map':['pwdLastSet'],                   'Standard Name':'dsAttrTypeStandard=SMBPasswordLastSet'},
                                     ...
                                     {'Native Map':['userWorkstations'],             'Standard Name':'dsAttrTypeStandard=SMBUserWorkstations'},
                                     ...
                                     {'Native Map':['sambaPrimaryGroupSID'],         'Standard Name':'dsAttrTypeStandard=SMBPrimaryGroupSID'},
                                     {'Native Map':['apple-keyword'],                'Standard Name':'dsAttrTypeStandard=Keywords'},
                                     {'Native Map':['apple-generateduid'],           'Standard Name':'dsAttrTypeStandard=GeneratedUID'},
                                     ...
                                     {'Native Map':['facsimileTelephoneNumber'],     'Standard Name':'dsAttrTypeStandard=FAXNumber'},
                                     ...
                                     {'Native Map':['userCertificate;binary'],       'Standard Name':'dsAttrTypeStandard=UserCertificate'},
                                     {'Native Map':['userPKCS12'],                   'Standard Name':'dsAttrTypeStandard=UserPKCS12Data'},
                                     {'Native Map':['userSMIMECertificate'],         'Standard Name':'dsAttrTypeStandard=UserSMIMECertificate'},
                                     {'Native Map':['apple-mapcoordinates'],         'Standard Name':'dsAttrTypeStandard=MapCoordinates'},
                                     {'Native Map':['apple-relationships'],          'Standard Name':'dsAttrTypeStandard=Relationships'},
                                     {'Native Map':['apple-postaladdresses'],        'Standard Name':'dsAttrTypeStandard=PostalAddressContacts'},
                                     {'Native Map':['apple-emailcontacts'],          'Standard Name':'dsAttrTypeStandard=EMailContacts'},
                                     {'Native Map':['apple-phonecontacts'],          'Standard Name':'dsAttrTypeStandard=PhoneContacts'},
                                     ...
                                     {'Native Map':['apple-serviceslocator'],        'Standard Name':'dsAttrTypeStandard=ServicesLocator'},
                                     ...
                                     {'Native Map':['apple-organizationinfo'],       'Standard Name':'dsAttrTypeStandard=OrganizationInfo'},
                                     ...
                                     {'Native Map':['altSecurityIdentities'],        'Standard Name':'dsAttrTypeStandard=AltSecurityIdentities'}],
            ...
            {'Standard Name'      :   'dsRecTypeStandard=CertificateAuthorities',
             'Attribute Type Map' : [{'Native Map':['cn'],                              'Standard Name':'dsAttrTypeStandard=RecordName'},
                                     {'Native Map':['authorityRevocationList;binary'],  'Standard Name':'dsAttrTypeStandard=AuthorityRevocationList'},
                                     {'Native Map':['certificateRevocationList;binary'],'Standard Name':'dsAttrTypeStandard=CertificateRevocationList'},
                                     {'Native Map':['cACertificate;binary'],            'Standard Name':'dsAttrTypeStandard=CACertificate'},
                                     {'Native Map':['crossCertificatePair;binary'],     'Standard Name':'dsAttrTypeStandard=CrossCertificatePair'}],
             'Native Map'         : [{'Group Object Classes' :  'AND',
            ...
            {'Standard Name'      :   'dsRecTypeStandard=Computers',
             ...
             'Native Map'         : [{'Group Object Classes' : 'OR',
                                      'Object Classes'       : ['ipaHost','krbPrincipal','krbPrincipalAux','apple-user','ieee802Device'],
           ...
           {'Standard Name'       : 'dsRecTypeStandard=Config',
            'Attribute Type Map'  : [{'Native Map':['cn','ou'],                       'Standard Name':'dsAttrTypeStandard=RecordName'},
                                     {'Native Map':['apple-config-realname'],         'Standard Name':'dsAttrTypeStandard=RealName'},
                                     {'Native Map':['description'],                   'Standard Name':'dsAttrTypeStandard=Comment'},
                                     ...
                                     {'Native Map':['apple-kdc-configdata'],          'Standard Name':'dsAttrTypeStandard=KDCConfigData'},
                                     {'Native Map':['apple-keyword'],                 'Standard Name':'dsAttrTypeStandard=Keywords'},
                                     {'Native Map':['apple-ldap-replica'],            'Standard Name':'dsAttrTypeStandard=LDAPReadReplicas'},
                                     {'Native Map':['apple-ldap-writable-replica'],   'Standard Name':'dsAttrTypeStandard=LDAPWriteReplicas'},
                                     {'Native Map':['apple-password-server-list'],    'Standard Name':'dsAttrTypeStandard=PasswordServerList'},
                                     {'Native Map':['apple-password-server-location'],'Standard Name':'dsAttrTypeStandard=PasswordServerLocation'},
            ...
            {'Standard Name'      : 'dsRecTypeStandard=Automount',
             'Attribute Type Map' : [{'Native Map':['description'],         'Standard Name':'dsAttrTypeStandard=Comment'},
                                     {'Native Map':['automountInformation'],'Standard Name':'dsAttrTypeStandard=AutomountInformation'},
